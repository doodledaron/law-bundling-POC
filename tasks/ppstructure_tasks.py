...
# Import helper functions from tasks.helpers module
from tasks.helpers import (
    REGION_COLORS, process_output_for_json, extract_layout_regions,
    extract_image_from_region, draw_bounding_boxes, update_active_processes_worker
)
...
# Helper functions (process_output_for_json, extract_layout_regions, etc.) are now
# imported from tasks.helpers at the top of this file.
...
# process_document_with_gemini_only has been moved to tasks.gemini_tasks
# merge_and_summarize_chunks has been moved to tasks.merge_tasks
